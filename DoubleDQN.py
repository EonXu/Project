...
class DoubleDQN:
    def __init__(self, args):
        ...
        self.target_dqn = RNN(input_shape, args)
        if self.args.cuda:
            self.eval_dqn.cuda()
        ...
        self.model_dir = './model/'+ args.env + '_Seed' + str(
            args.seed) + '_DoubleDQN' + '_{}a{}t(AM{}TM{})'.format(args.n_agents, args.target_num, args.agent_mode,
                                                                     args.target_mode)
        ...
        print('Init alg DoubleDQN(seed = {})'.format(self.seed))
    ...
    def get_q_values(self, batch, max_episode_len):
        ...
        for transition_idx in range(max_episode_len):
            ...
            q_target, self.target_hidden = self.target_dqn(inputs_next, self.target_hidden)
    ...
    def save_model(self, train_step):
        ...
        torch.save(self.target_dqn.state_dict(), self.model_dir + '/' + idx + '_target_dqn_net_params.pkl')
    ...
    def load_model(self, dqn_root,target_root):
        self.eval_dqn.load_state_dict(torch.load(dqn_root))
        self.target_dqn.load_state_dict(torch.load(target_root))
